...
export default class Sample extends Component {
	...
	viewerContainerElementRef = React.createRef();
	viewerEditorElementRef = React.createRef();
	viewerSidebarContainerElementRef = React.createRef();
				...
				<main>
					<div className="message">
						<div className="centered">
							<h2>CKEditor 5 React integration of classic editor with real-time collaboration and revision history</h2>
							<p>
		...
		return (
			<div className="row row-editor">
				<div className="editors-holder">
					<div className='editor-container' ref={ this.editorContainerRef }>
