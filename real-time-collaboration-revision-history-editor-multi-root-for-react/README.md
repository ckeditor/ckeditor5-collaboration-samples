# CKEditor 5 multi-root editor with real-time collaborative editing and revision history sample for React
...
1. Clone the repository:
   ...
   cd ckeditor5-collaboration-samples/real-time-collaboration-revision-history-editor-multi-root-for-react
   ```

2. Open the `samples/real-time-collaboration-revision-history-editor-multi-root-for-react.html` page in the browser.
