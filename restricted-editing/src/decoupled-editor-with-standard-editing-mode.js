...
class DecoupledEditorWithStandardEditingMode extends BaseEditor {}

DecoupledEditorWithStandardEditingMode.builtinPlugins = [
	Alignment,
	Autoformat,
	BlockQuote,
	Bold,
...
DecoupledEditorWithStandardEditingMode.defaultConfig = {
...
export default { Watchdog, DecoupledEditorWithStandardEditingMode };
