...
This repository presents a [multi-root editor type](https://ckeditor.com/docs/ckeditor5/latest/examples/framework/multi-root-editor.html) of CKEditor 5 including
...
The application uses the `useMultiRootEditor()` React hook provided by the [@ckeditor/ckeditor5-react](https://github.com/ckeditor/ckeditor5-react) package.
