	...
	function createDialog() {
		...
		overlay.innerHTML = `
			<form class="body">
				...
				<div><label for="ckbox-token-url">CKBox token URL (optional)</label><input id="ckbox-token-url"></div>
		...
		ckboxTokenUrlInput.value = csConfig.ckboxTokenUrl || '';
		...
		return new Promise( resolve => {
			form.addEventListener( 'submit', evt => {
				...
				storeConfig( {
					...
					ckboxTokenUrl: ckboxTokenUrlInput.value,
