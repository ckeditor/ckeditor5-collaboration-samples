# CKEditor 5 document editor with real-time collaboration

This repository presents a [document editor build](https://ckeditor.com/docs/ckeditor5/latest/builds/guides/overview.html#document-editor) with [real-time collaboration features](https://ckeditor.com/docs/ckeditor5/latest/features/collaboration/real-time-collaboration/real-time-collaboration.html).
...
1. Clone the repository:
   ...
   cd ckeditor5-collaboration-samples/real-time-collaboration-editor-document
   ```

2. Open the `samples/real-time-collaboration-editor-document.html` page in the browser.
