...
export default function RootLayout( { children } ) {
	return (
		<html>
			...
			<head>
				<title>CKEditor 5 collaborative editing for Next.js</title>
				<meta charSet="UTF-8" />
			...
			<body>
				...
				<main>
					<div className="message">
						<div className="centered">
							<h2>CKEditor 5 collaborative editing for Next.js</h2>
						</div>
					</div>
				...
				<footer>
					<div className="centered">
						...
						<p>Copyright © 2003-2026, <a href="https://cksource.com/" target="_blank" rel="noopener noreferrer">CKSource</a> –
							Holding
