# CKEditor 5 revision history with real-time collaborative editing sample
...
1. Clone the repository:
   ...
   cd ckeditor5-collaboration-samples/real-time-collaboration-revision-history
   ```

2. Open the `samples/real-time-collaboration-revision-history.html` page in the browser.
