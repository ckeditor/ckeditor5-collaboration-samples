...
module.exports = {
	...
	entry: path.resolve( __dirname, 'src', 'real-time-collaboration-revision-history.js' ),

	output: {
		// The name under which the editor will be exported.
		library: 'RevisionHistoryWithRealTimeCollaboration',

		path: path.resolve( __dirname, 'build' ),
		filename: 'real-time-collaboration-revision-history.js',
		libraryTarget: 'umd',
