...
1. Clone the repository:
   ...
   cd ckeditor5-collaboration-samples/real-time-collaboration-comments-outside-of-editor-for-react
   ```

2. Open the `samples/real-time-collaboration-comments-outside-of-editor-for-react.html` page in the browser.
