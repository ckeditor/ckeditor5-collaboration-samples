...
Using `Context` allows to instantiate multiple editor instances easier, however for cases when you may need multiple editable areas, not necessarily multiple editor instances, the multi-root editor shown here is a recommended approach.
