...
module.exports = {
	...
	entry: path.resolve( __dirname, 'src', 'real-time-collaboration-editor-multi-root.js' ),

	output: {
		// The name under which the editor will be exported.
		library: 'MultiRootEditorWithRealTimeCollaboration',

		path: path.resolve( __dirname, 'build' ),
		filename: 'real-time-collaboration-editor-multi-root.js',
		libraryTarget: 'umd',
